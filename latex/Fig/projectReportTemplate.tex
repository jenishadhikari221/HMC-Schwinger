...
\begin{figure}[b]
\includegraphics[width=.5\textwidth]{example-image-a}% Here is how to import EPS art
\caption{\label{fig:epsart} A figure caption. The figure captions are
automatically numbered.}
\end{figure}

\section{Floats: Figures, Tables}
...
\begin{figure*}
\includegraphics{example-image-b}% Here is how to import EPS art
